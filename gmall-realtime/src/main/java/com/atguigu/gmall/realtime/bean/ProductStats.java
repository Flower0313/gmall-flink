 ...
 * @Create 2021年12月21日19:43 - 周二
 * @Describe 商品统计实体类(28个字段)
...
public class ProductStats {
    ...
    @Builder.Default//这里该默认值,就是防止后面数据+null,就会报错,所以给一个默认值0L
    ...
    @Builder.Default
    @TransientSink//辅助字段,不需要写入ClickHouse
    Set orderIdSet = new HashSet();  //用于统计订单数,自动去重
